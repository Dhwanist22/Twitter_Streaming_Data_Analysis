...
class StreamToPubsub(tweepy.StreamListener):
    def __init__(self):
        super().__init__()
        self.project_id = 'mydemoproject-22'
        self.topic_id = 'NewTopic'
...
with open('TwitterCrendials.json') as file:
    twitter_credentials = json.load(file)
gcp_json_key = "mydemoproject-22.json"
...
if __name__ == "__main__":
    ...
    stream.filter(track=["covid-19", "covid 19 india", "covid india"], languages=['en'])